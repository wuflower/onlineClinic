...
<head>
    ...
    <style type="text/css">
        .side{width:100px; float:left; display:inline;background-color: darkgray}
        .main{width:100px; float:left; display:inline;background-color: whitesmoke}
    </style>
    <style>
...
<div class="diagnose-page">
    <div class="side" style="width:12%;height:100%;" >
        <ul>

            <li ><a id="clinicManage" href="#">诊所管理</a>
                <ul id="clinicManageSublevel" style="display: none">
                    <li><a href="#">员工管理</a></li>
                    <li><a href="#">会员管理</a></li>
                    <li><a href="#">查询统计</a></li>
                </ul>
            ...
            <li><a href="/onlineClinic/customer/platformManage">首页</a></li>
...
<script type="text/javascript">
    $().ready(function(){
        $("#clinicManage").click(function(){
            $("#clinicManageSublevel").toggle()
        })
        var span1 = $("#diaCharge");
