...
public final class UniversalEnumHandler<E extends BaseEnum> extends BaseTypeHandler<E> {
    ...
    public void setNonNullParameter(PreparedStatement ps, int i, E parameter,
        ...
        ps.setObject(i,parameter.getStatus(), jdbcType.TYPE_CODE);
    }
    ...
    public E getNullableResult(ResultSet rs, String columnName)
        ...
        if (rs.wasNull()) {
            ...
            return locateEnumStatus(Integer.valueOf(i));
        }
    }
     ...
     * @param status 数据库中存储的自定义value属性
     * @return value对应的枚举类
     */
    private E locateEnumStatus(Integer status) {
        for(E e : enums) {
