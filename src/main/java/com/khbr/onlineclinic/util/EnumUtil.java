...
public class EnumUtil {
    ...
    private static <T> Object getMethodValue(String methodName, T obj,
        ...
        try {
            /********************************* start *****************************************/
            java.lang.reflect.Method[] methods = obj.getClass().getMethods(); //获取方法数组，这里只要共有的方法
            if (methods.length <= 0) {
                return resut;
            }
    ...
    public static <T> Object getEnumDescriotionByValue(Object value,
        ...
        String valueMathod = "getStatus";    //默认获取枚举value方法，与接口方法一致
        String desMathod = "getMessage"; //默认获取枚举description方法
    ...
    public static <T> String getEnumKeyByValue(Object value, Class<T> enumT,
        ...
        int count = methodNames.length;
        String valueMathod = "getStatus"; //默认方法
    ...
    public static <T> Map<Object, String> EnumToMap(Class<T> enumT,
        ...
        int count = methodNames.length;
        String valueMathod = "getStatus"; //默认接口value方法
        String desMathod = "getMessage";//默认接口description方法
